...
enum RouterVersion {
  OnzechainRouter01 = 'OnzechainRouter01',
  OnzechainRouter02 = 'OnzechainRouter02'
}

describe('OnzechainRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.OnzechainRouter01]: fixture.router01,
        [RouterVersion.OnzechainRouter02]: fixture.router02
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.OnzechainRouter01]: 105398,
              [RouterVersion.OnzechainRouter02]: 105420
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
