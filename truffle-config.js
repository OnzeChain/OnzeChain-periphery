 ...
 */
 ...
 const { API_URL, MNEMONIC_KEY } = process.env;
...
// server.keepAliveTimeout = 61 * 1000;
 ...
 module.exports = {
   ...
   networks: {
     ...
     ropsten: {
     provider: () => new HDWalletProvider(MNEMONIC_KEY, `https://ropsten.infura.io/v3/YOUR-PROJECT-ID`),
     ...
     mumbai: {
     provider: function (){ return new HDWalletProvider(MNEMONIC_KEY, API_URL);},
